...
"""
Django settings for stitch_project project.
...
SECRET_KEY = 'django-insecure-@u9#_se7xdk#13uh=xtp!it2vau9zg-=_c+=1_)apz3&=p-)ps'
...
TEMPLATES = [
    {
        ...
        'DIRS': [],  # Si quieres plantillas globales puedes poner aquí una ruta
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'stitch_project.wsgi.application'
